  ...
  <p className="text-slate-600 dark:text-slate-300 max-w-2xl mx-auto">
    ...
    <div className='flex justify-center'>
        <div className='flex flex-col items-center p-10'>
            <div className='flex text-slate-500 t'> 
                {/* <PiCopyrightThin /><p className='mb-1'>BlogGenius. All right reserved.</p> */}
           </div>
           
           <p className='text-slate-500'>Powered by Ai to create SEO-optimized content.</p>
        </div>
